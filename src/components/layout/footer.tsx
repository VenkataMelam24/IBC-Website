...
export function Footer() {
  return (
    <footer className="bg-primary">
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 py-8 md:gap-10 md:py-12 lg:grid-cols-[1.3fr_1fr_1fr] lg:px-10">
        <div>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/images/logo-new.png" alt="IBC — Indian Biryani Company" className="h-10 w-auto md:h-14" style={{ filter: "brightness(0) invert(1)" }} />
        ...
        <div>
          ...
          <div className="mt-4 space-y-2 text-sm text-primary-foreground/75">
            ...
            <span className="flex items-center gap-1.5">
              +49 177 3771839
              <a href="https://wa.me/491773771839" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="inline-flex text-[#25d366] transition-opacity hover:opacity-80">
