import { Document, Page, View, Text, StyleSheet, Image, Link, Svg, Path } from "@react-pdf/renderer";
      ...
      <View style={S.footer} fixed>
        ...
        <View style={S.footerCol}>
          <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 2 }}>
            <Link src={`https://wa.me/${data.whatsappPhone.replace(/[^0-9]/g, "")}`} style={{ textDecoration: "none" }}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                ...
                <Text style={[S.footerLine, { color: "#25D366" }]}>{data.whatsappPhone}</Text>
              </View>
            </Link>
          </View>
          <Text style={S.footerLine}>{data.phone}</Text>
          <Text style={S.footerLine}>{data.contactEmail}</Text>
        </View>
        <View style={S.footerCol}>
